...
function scene:create()
    ...
    if cartaoConsultado.letras ~= nil then
        ...
        numeroText = display.newText({text = "Número: ".. cartaoConsultado.numero, x = display.contentWidth/2, y = display.contentHeight/10 * 7.5, whidth = display.contentWidth/10 * 7, height = display.contentHeight/10 * 2, fontSize = 20, Textalign = "left"})
    
        placaText = display.newText({text = "Placa: ".. cartaoConsultado.placa.letras .. "-" .. cartaoConsultado.placa.numeros, x = display.contentWidth/2, y = display.contentHeight/10 * 8.5,whidth = display.contentWidth/10 * 7, height = display.contentHeight/10 * 2, fontSize = 20, Textalign = "left"})
    
        dataText = display.newText({text = "Restante: " .. cartaoConsultado.dataFim, x = display.contentWidth/2, y = display.contentHeight/10 * 9.5, whidth = display.contentWidth/10 * 7, height = display.contentHeight/10 * 2, fontSize = 20, Textalign = "left"})

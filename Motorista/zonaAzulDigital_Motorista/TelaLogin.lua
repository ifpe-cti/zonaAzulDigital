...
function scene:create()
    ...
    local entrar = widget.newButton({label = "ENTRAR", labelColor = { default={ 1, 1, 1 }, over={0, 0, 0} }, fontSize = 14 , x = display.contentWidth/2, y = display.contentHeight/3.2 * 2, width = display.contentWidth/1.5, height = display.contentHeight/12, shape = "roundedRect", fillColor = { default={ 0.2, 0.2, 1, 1 }, over={ 0.8, 0.8, 1} } })

    local cadastro = widget.newButton({label = "Cadastre-se",labelColor = { default={ 0.2, 0.2, 1, 1 }, over={0, 0, 0} },fontSize = 18 ,  textOnly = true, x = display.contentWidth/2, y = display.contentHeight/ 2.6 * 2, width = display.contentWidth/1.5, height = display.contentHeight/12, shape = "roundedRect", fillColor = { default={ 0.2, 0.2, 1, 0 }, over={ 0.8, 0.8, 1 } } })
